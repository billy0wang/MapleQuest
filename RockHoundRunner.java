...
public class RockHoundRunner
{
    public static void main(String[] args)
    {
        ...
        world.add(new Location(4, 8), new Flower(Color.BLUE));
        world.add(new Location(6, 8), new Flower(Color.PINK));
        world.add(new Location(5, 7), new Bug());
        world.add(new Location(5, 9), new Bug());
        world.add(new Location(4, 7), new Actor());
        world.add(new Location(4, 9), new Actor());
        world.add(new Location(6, 7), new Actor());
        world.add(new Location(6, 9), new Actor());
        ...
        RockHound riley= new RockHound();
        RockHound ralphy= new RockHound();
        world.add(new Location(4, 4), riley);
        world.add(new Location(5, 8), ralphy);
        world.show();
    }
}