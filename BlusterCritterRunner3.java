 ...
 */
public class BlusterCritterRunner3{
	public static void main(String[] args){
		...
		Actor nActor8 = new info.gridworld.actor.Flower();
		nActor8.setColor(new Color(255,175,175));
		...
		Actor nActor10 = new info.gridworld.actor.Flower();
		nActor10.setColor(new Color(255,175,175));
		world.add(new Location(2, 4), nActor10);
		Actor nActor11 = new info.gridworld.actor.Actor();
		nActor11.setColor(new Color(0,255,0));
		world.add(new Location(2, 5), nActor11);
		Actor nActor12 = new info.gridworld.actor.Flower();
		nActor12.setColor(new Color(255,175,175));
		...
		Actor nActor17 = new info.gridworld.actor.Actor();
		nActor17.setColor(new Color(255,200,0));
		world.add(new Location(3, 3), nActor17);
		Actor nActor18 = new info.gridworld.actor.Flower();
		nActor18.setColor(new Color(255,175,175));
		world.add(new Location(3, 4), nActor18);
		Actor nActor19 = new info.gridworld.actor.Flower();
		nActor19.setColor(new Color(255,175,175));
		world.add(new Location(3, 5), nActor19);
		Actor nActor20 = new info.gridworld.actor.Flower();
		nActor20.setColor(new Color(255,175,175));
		...
		Actor nActor23 = new info.gridworld.actor.Actor();
		nActor23.setColor(new Color(255,0,0));
		world.add(new Location(4, 2), nActor23);
		Actor nActor24 = new info.gridworld.actor.Bug();
		nActor24.setColor(new Color(0,0,255));
		world.add(new Location(4, 3), nActor24);
		Actor nActor25 = new BlusterCritter(1);
		nActor25.setColor(new Color(1,1,1));
		world.add(new Location(4, 4), nActor25);
		Actor nActor26 = new info.gridworld.actor.Actor();
		nActor26.setColor(new Color(0,255,255));
		world.add(new Location(4, 5), nActor26);
		Actor nActor27 = new info.gridworld.actor.Rock();
		nActor27.setColor(new Color(0,0,0));
		...
		Actor nActor30 = new info.gridworld.actor.Flower();
		nActor30.setColor(new Color(255,175,175));
		...
		Actor nActor33 = new info.gridworld.actor.Actor();
		nActor33.setColor(new Color(255,0,255));
		world.add(new Location(5, 5), nActor33);
		Actor nActor34 = new info.gridworld.actor.Bug();
		nActor34.setColor(new Color(255,0,0));
		...
		Actor nActor37 = new info.gridworld.actor.Flower();
		nActor37.setColor(new Color(255,175,175));
		...
		Actor nActor39 = new info.gridworld.actor.Bug();
		nActor39.setColor(new Color(255,0,0));
		...
		Actor nActor41 = new info.gridworld.actor.Flower();
		nActor41.setColor(new Color(255,175,175));
